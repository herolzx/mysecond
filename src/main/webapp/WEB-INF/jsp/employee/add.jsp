...
<!-- 引入自己的js -->
<script type="text/javascript" language="javascript"
	src="assets/employee/add.js"></script>
</head>
<!-- 身体部分 -->
<body>
	<div class="container">
		<fieldset>
			...
			<form class="employee-form" action="employee/add" method="post">
				...
				<div>
					<label for="departmentId">部门编号:</label> <input type="text"
						name="departmentId" id="departmentId" placeholder="请输入员工部门"
						value="${emp.department}">
				</div>
				<div>
					<label for="birthday">出生日期：</label>
					 <input type="text" name="birthday" id="birthday" placeholder="请输入出生日期" 
					value="<fmt:formatDate value="${emp.birthday }" pattern="yyyy-MM-dd" />" autocomplete="off">
				</div>
				
				<%-- <label for="birthday">出生日期:</label> 
				<input type="text" name="birthday" id="birthday" placeholder="请选择出生日期"
						value="${emp.birthday}" autocomplete="off"> --%>
				...
				<div class="div-wrapper">
					...
					<div>
						<input type="radio" id="female" name="sex" value="女"> <label
							for="female">女</label>
					</div>
				</div>
